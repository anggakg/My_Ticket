    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnplus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                valuejumlahtiket+=1;
                textjumlahtiket.setText(valuejumlahtiket.toString());
                //jika jumlah tiket lebih dari 1 btnmines muncul/tetap ada
                ...
                valuetotalharga = valuehargatiket * valuejumlahtiket;
                texttotalharga.setText("US$ " + valuetotalharga);
                //jika valuetotalharga lebih dari mybalance maka btn_buy_ticket menghilang
        ...
        btnmines.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                valuejumlahtiket-=1;
                textjumlahtiket.setText(valuejumlahtiket.toString());
                //jika jumlah tiket kurang dari 2 btnmines menghilang
                ...
                valuetotalharga = valuehargatiket * valuejumlahtiket;
                texttotalharga.setText("US$ " + valuetotalharga);
                //jika valuetotalharga kurang dari mybalance maka btn_buy_ticket muncul/tetap ada
                if(valuetotalharga <= mybalance){
